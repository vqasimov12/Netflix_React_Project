...
const FAQItem = ({ title, desc, id, openItem, setOpenItem }) => {
  ...
  return (
    <div className="flex flex-col  bg-[#2d2d2d] justify-center w-full ">
      <button
        onClick={() => {
          setOpenItem((prevState) => (prevState !== id ? id : null));
        }}
        className="w-full  hover:bg-[#414141] transition duration-200 ease-in items-center text-[18px] justify-between lg:text-[24px] flex h-[72px] lg:h-[84px] p-6 border-b-[1px] border-b-black"
      >
